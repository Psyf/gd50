...
function PlayState:update(dt)
    ...
    if scrolling == true then 
        ...
        if self.timer > self.randomDelay then
            ...
            -- randomize next PipePair generation between 2 and 4 seconds. 
            self.randomDelay = math.random(0, 2) + 2
        end
...
function PlayState:render()
    ...
    if scrolling == false then 
        love.graphics.print('PAUSE', VIRTUAL_WIDTH/2-80, VIRTUAL_HEIGHT/2-30, 0, 2, 2)
    end
end
